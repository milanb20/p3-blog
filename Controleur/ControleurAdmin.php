...
class ControleurAdmin extends ControleurSecurise
{
    ...
    public function index()
    {
        ...
        $this->genererVue(array('nbBillets' => $nbBillets, 'nbCommentaires' => $nbCommentaires, 'login' => $login, 'billets'=> $billets));
    }
    ...
    public function inscription()
      ...
      public function modifierMdp()
          ...
          public function modifierBillet()
              {
                $billet = $this->billet->getBillet($this->requete->getParametre('id'));
                if ($this->requete->existeParametre("id") && $this->requete->existeParametre("dateBillet") && $this->requete->existeParametre("titreBillet") && $this->requete->existeParametre("contenuBillet")) {
                    $idBillet = $this->requete->getParametre('id');
                    $dateBillet = $this->requete->getParametre('dateBillet');
                    $titreBillet = $this->requete->getParametre('titreBillet');
                    $contenuBillet = $this->requete->getParametre('contenuBillet');
                    $this->billet->modifierBillet($idBillet,$dateBillet, $titreBillet, $contenuBillet);
                    $session = $this->requete->getSession();
                    $this->rediriger("admin","modifierBillet/".$idBillet);
